...
const (
	...
	corazaDisabledAnnotation                 = "coraza-disabled"
	corazaDirectivesAnnotation               = "coraza-directives"
	corazaRuleEngineAnnotation               = "coraza-rule-engine"
	corazaDisableRulesAnnotation             = "coraza-disable-rules"
	corazaDisableRulesByTagAnnotation        = "coraza-disable-rules-by-tag"
	corazaParanoiaLevelAnnotation            = "coraza-paranoia-level"
	corazaAnomalyThresholdInboundAnnotation  = "coraza-anomaly-threshold-inbound"
	corazaAnomalyThresholdOutboundAnnotation = "coraza-anomaly-threshold-outbound"
	corazaBlockedIPsAnnotation               = "coraza-blocked-ips"
)
